...
namespace Photon.Pun.KyleDemo
{
	...
	public class Launcher : MonoBehaviourPunCallbacks
    {
		...
		[Tooltip("The Ui Text to let the player know they are connecting")]
		[SerializeField]
		...
		public void Connect()
		{
			...
			{
				LogFeedback("Joining Room in region " + PhotonNetwork.CloudRegion);
        ...
        public override void OnConnectedToMaster()
		{
			...
			LogFeedback("OnConnectedToMaster called, you are now connected! Press the button again to join an open lobby room");
			connectText.gameObject.SetActive(false);
			...
			/*if (isConnecting)
			{
				...
				Debug.Log("Joining Room in region " + PhotonNetwork.CloudRegion);
		...
		{
			Debug.Log("You have created a room! There are now " + PhotonNetwork.CountOfRooms + " rooms");
			base.OnCreatedRoom();
		}
